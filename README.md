...
### _Web Summit creates the room. Pulse helps you find who to talk to right now._
...
>
> We came in with a single belief: _the real problem at live events isn’t discovery, it’s timing._
> We left with a trophy, a story, and a product that felt like _the missing layer of every conference._
...
| 📡  | A live Radar that _felt_ alive — animated pulses, real-time matches, zero awkward silence                  |
...
> _It is day two of Web Summit._
...
> ### 💡 Pulse does not ask, _“Who should I connect with someday?”_
>
> ### 📡 Pulse asks, _“Who should I talk to right now?”_
...
Attendees broadcast short-lived intent through **Quests**. Pulse then visualizes nearby matches on a **live Radar**, explains _why_ each match is relevant, and helps people form small, useful conversations in the moment.
...
_Then helps you keep the conversations worth remembering._
